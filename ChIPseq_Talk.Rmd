...
* Spike-In chromatin: synthetic or different species
...
plotRanges(ranges_1_region, 
           my_region = my_region, 
           my_title = "region #1 (n=6)", my_color = cbPalette[1])

plotRanges(ranges_2_region,  
           my_region = my_region, 
           my_title = "region #2 (n=4)", my_color = cbPalette[2])
...
par(mfrow=c(4,1),mar = c(1,3,1,3))


plotRanges(ranges_1_region, 
           my_region = my_region, 
           my_title = "region #1", my_color = cbPalette[1])

plotRanges(ranges_2_region,  
           my_region = my_region, 
           my_title = "region #2", my_color = cbPalette[2])

plotRanges(union(ranges_1_region, ranges_2_region),  my_region = my_region,  
           my_title = "union - intersect", my_color = cbPalette[3])
...
```{r message=FALSE, warning=FALSE,results=FALSE, fig.align='center', fig.height=6, fig.width=6, dpi=200, out.width='50%'}
cbPalette <- c("#E69F00", "#D55E00", "#56B4E9", "#999999", "#009E73", "#F0E442", "#0072B2", "#CC79A7")
...
m <- matrix(nrow = 4, ncol = 4, dimnames = list(c("H3K36me3_1","H3K36me3_2", "H2Av_1","H2Av_2"),
                                                c("H3K36me3_1","H3K36me3_2", "H2Av_1","H2Av_2")))
